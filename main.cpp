...
MatrixXd full_run(MatrixXd A, VectorXd b, DikinWalk walk,float r, int num_sim){
    int x_dim = A.cols();
...
MatrixXd full_run(MatrixXd A, VectorXd b, VaidyaWalk walk,float r, int num_sim){
    int x_dim = A.cols();
...
MatrixXd full_run(MatrixXd A, VectorXd b, DikinLSWalk walk,float r, int num_sim){
    int x_dim = A.cols();
...
MatrixXd full_run(MatrixXd A, VectorXd b, JohnWalk walk,float r, int num_sim){
    int x_dim = A.cols();

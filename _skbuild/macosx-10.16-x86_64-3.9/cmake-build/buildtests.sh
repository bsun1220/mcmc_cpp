...
then
  /private/var/folders/7s/6wrlqwfs5y1g71y3cg83c94c0000gn/T/pip-build-env-2rz8ihxq/overlay/lib/python3.9/site-packages/ninja/data/bin/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /private/var/folders/7s/6wrlqwfs5y1g71y3cg83c94c0000gn/T/pip-build-env-2rz8ihxq/overlay/lib/python3.9/site-packages/ninja/data/bin/ninja $targets_to_make 
fi
exit $?
